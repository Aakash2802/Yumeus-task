...
export default function Blog() {
  ...
  return (
    <section className="w-full bg-white py-8 sm:py-12 lg:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 sm:mb-12 lg:ml-40 gap-4">
          <div>
  ...
  RECENT BLOG
          ...
          <button className="hidden md:block px-3 py-2 sm:mt-10 border-2 border-gray-900 rounded-full text-xs hover:bg-gray-900 hover:text-white transition whitespace-nowrap">
            VIEW ALL POST
          </button>
        </div>
          ...
          {posts.map((post, index) => (
            ...
            >
              <div className="relative w-full h-40 sm:h-48">
                ...
                />
                {/* Date Badge */}
                <div className="absolute bottom-0 right-3 sm:right-4 bg-white rounded-t-lg px-2 sm:px-3 py-1.5 sm:py-2 shadow-md">
        ...
        <div className="mt-6 sm:mt-8 text-center hidden sm:block md:hidden">
          <button className="px-5 sm:px-6 py-2 border-2 border-gray-900 rounded-full text-xs sm:text-sm font-semibold hover:bg-gray-900 hover:text-white transition">
            VIEW ALL POST
          </button>
        </div>
      </div>
